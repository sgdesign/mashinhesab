...
package com.duy.calculatorsgh.graph;
...
import com.duy.calculatorsgh.evaluator.DecimalFactory;
...
public class Graph2DView extends View implements OnTouchListener {
    ...
    /*
     * Redraws the com.duy.example.com.duy.calculatorsgh.graph
     */
    ...
    /*
     * Draws a solution to a differential equation to the com.duy.example.com.duy.calculatorsgh.graph using the
...
//        double y = initY;
//
//        // Draws the portion of the com.duy.example.com.duy.calculatorsgh.graph between x=0 and the right edge
...
//        y = initY;
//
//        // Draws the portion of the com.duy.example.com.duy.calculatorsgh.graph between x=0 and the left edge
...
//        }
    ...
    /*
     * Draws either the trace or derivative values to the com.duy.example.com.duy.calculatorsgh.graph
     */
    ...
    /*
     * Moves the com.duy.example.com.duy.calculatorsgh.graph
     */
    ...
    /*
     * Zooms the com.duy.example.com.duy.calculatorsgh.graph in and out
     */
