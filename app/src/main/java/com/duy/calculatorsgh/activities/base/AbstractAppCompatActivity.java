...
import com.duy.calculatorsgh.BuildConfig;
import com.duy.calculatorsgh.R;
import com.duy.calculatorsgh.data.CalculatorSetting;
import com.duy.calculatorsgh.data.DatabaseHelper;
import com.duy.calculatorsgh.helper.LocaleHelper;
import com.duy.calculatorsgh.userinterface.FontManager;
import com.duy.calculatorsgh.userinterface.ThemeEngine;
...
public abstract class AbstractAppCompatActivity extends AppCompatActivity
    ...
    protected void shareApp() {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "https://cafebazaar.ir/app/details?id=" + BuildConfig.APPLICATION_ID);
    ...
    public void gotoPlayStore(String appId) {
        ...
        try {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("https://cafebazaar.ir/app/details?id=" + appId)));
        }
    }
