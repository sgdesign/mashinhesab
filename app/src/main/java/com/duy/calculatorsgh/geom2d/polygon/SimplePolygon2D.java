...
import com.duy.calculatorsgh.geom2d.util.AffineTransform2D;
 ...
 */
public class SimplePolygon2D implements com.duy.calculatorsgh.geom2d.polygon.Polygon2D {
    ...
    public int getWindingNumber(double x, double y) {
        return com.duy.calculatorsgh.geom2d.polygon.Polygons2D.windingNumber(vertices, new Point2D(x, y));
    }
    ...
    public SimplePolygon2D simplify(double distMax) {
        return new SimplePolygon2D(com.duy.calculatorsgh.geom2d.polygon.Polylines2D.simplifyClosedPolyline(this.vertices, distMax));
    }
     ...
     */
    public double area() {
        return com.duy.calculatorsgh.geom2d.polygon.Polygons2D.computeArea(this);
    }
    ...
    public Point2D centroid() {
        return com.duy.calculatorsgh.geom2d.polygon.Polygons2D.computeCentroid(this);
    }
     ...
     */
    public com.duy.calculatorsgh.geom2d.polygon.Polygon2D asPolygon( int n) {
        return this;
    }
