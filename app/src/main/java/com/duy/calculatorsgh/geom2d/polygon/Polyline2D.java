...
import com.duy.calculatorsgh.geom2d.line.StraightLine2D;
...
public class Polyline2D extends LinearCurve2D
{
    ...
    public Polyline2D simplify(double distMax) {
        return new Polyline2D(com.duy.calculatorsgh.geom2d.polygon.Polylines2D.simplifyPolyline(this.vertices, distMax));
    }
    ...
    public boolean isInside(Point2D pt) {
        if (new com.duy.calculatorsgh.geom2d.polygon.LinearRing2D(this.vertexArray()).isInside(pt))
            return true;
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.Curve2D#point(double, Point2D)
     */
