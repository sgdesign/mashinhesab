...
public class InvertedRay2D extends AbstractLine2D {
     ...
     */
    public InvertedRay2D(com.duy.calculatorsgh.geom2d.line.LinearShape2D line) {
     ...
     * @see Ray2D#reverse()
     */
    public com.duy.calculatorsgh.geom2d.line.Ray2D reverse() {
        return new com.duy.calculatorsgh.geom2d.line.Ray2D(x0, y0, -dx, -dy);
    }
