 ...
 *
 */
package com.duy.calculatorsgh.geom2d.polygon;
...
import com.duy.calculatorsgh.geom2d.curve.ContinuousCurve2D;
...
public abstract class LinearCurve2D implements ContinuousCurve2D {
     ...
     */
    public abstract com.duy.calculatorsgh.geom2d.line.LineSegment2D edge( int index);
     ...
     */
    public abstract Collection<com.duy.calculatorsgh.geom2d.line.LineSegment2D> edges();

    public com.duy.calculatorsgh.geom2d.line.LineSegment2D firstEdge() {
        if (vertices.size() < 2)
            return null;
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(vertices.get(0), vertices.get(1));
    }

    public abstract com.duy.calculatorsgh.geom2d.line.LineSegment2D lastEdge();
    ...
    public double length() {
        double sum = 0;
        for (com.duy.calculatorsgh.geom2d.line.LineSegment2D edge : this.edges())
            sum += edge.length();
        return sum;
    }
    ...
    public double position(double length) {
        ...
        for (com.duy.calculatorsgh.geom2d.line.LineSegment2D edge : edges()) {
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.OrientedCurve2D#signedDistance(Point2D)
     */
    ...
    public boolean isInside(Point2D point) {
        ...
        int winding = com.duy.calculatorsgh.geom2d.polygon.Polygons2D.windingNumber(this.vertices, point);
        if (area > 0) {
            return winding == 1;
        } else {
            return winding == 0;
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.OrientedCurve2D#signedDistance(double, double)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.ContinuousCurve2D#smoothPieces()
     */
    public Collection<? extends com.duy.calculatorsgh.geom2d.line.LineSegment2D> smoothPieces() {
        return edges();
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.Curve2D#position(Point2D)
     */
    public double position(Point2D point) {
        ...
        int i = 0;
        com.duy.calculatorsgh.geom2d.line.LineSegment2D closest = null;
        for (com.duy.calculatorsgh.geom2d.line.LineSegment2D edge : this.edges()) {
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.Curve2D#intersections(com.example.duy.com.duy.calculatorsgh.geom2d.LinearShape2D)
     */
