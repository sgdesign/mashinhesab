...
import com.duy.calculatorsgh.geom2d.util.Angle2D;
...
public abstract class AbstractLine2D extends AbstractSmoothCurve2D
        implements com.duy.calculatorsgh.geom2d.line.LinearShape2D {
    /**
    ...
    public boolean isColinear(LinearShape2D linear) {
        ...
        // test if the two lines share at least one point (see the contains()
        // method for details on tests)
        com.duy.calculatorsgh.geom2d.line.StraightLine2D line = linear.supportingLine();
    ...
    public com.duy.calculatorsgh.geom2d.line.StraightLine2D parallel( Point2D point) {
        return new com.duy.calculatorsgh.geom2d.line.StraightLine2D(point, this.dx, this.dy);
    }
    ...
    public com.duy.calculatorsgh.geom2d.line.StraightLine2D perpendicular( Point2D point) {
        return new com.duy.calculatorsgh.geom2d.line.StraightLine2D(point, -this.dy, this.dx);
    }
    ...
    public com.duy.calculatorsgh.geom2d.line.StraightLine2D supportingLine() {
        return new com.duy.calculatorsgh.geom2d.line.StraightLine2D(this);
    }
    ...
    public AbstractLine2D subCurve(double t0, double t1) {
        ...
        if (Double.isInfinite(t1)) {
            if (Double.isInfinite(t0))
                ...
                return new com.duy.calculatorsgh.geom2d.line.Ray2D(this.point(t0), this.direction());
        }

        if (Double.isInfinite(t0))
            return new InvertedRay2D(this.point(t1), this.direction());
        else
            return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(this.point(t0), this.point(t1));
