...
import com.duy.calculatorsgh.geom2d.line.LineSegment2D;
...
public class LinearRing2D extends LinearCurve2D {
    ...
    public LinearRing2D simplify(double distMax) {
        return new LinearRing2D(com.duy.calculatorsgh.geom2d.polygon.Polylines2D.simplifyClosedPolyline(this.vertices, distMax));
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.OrientedCurve2D#windingAngle(Point2D)
     */
    public double windingAngle(Point2D point) {
        int wn = com.duy.calculatorsgh.geom2d.polygon.Polygons2D.windingNumber(this.vertices, point);
        return wn * 2 * Math.PI;
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.OrientedCurve2D#isInside(Point2D)
     */
     ...
     */
    public com.duy.calculatorsgh.geom2d.Point2D point( double t) {
     ...
     * (non-Javadoc)
     * 
     * @see com.example.duy.com.duy.calculatorsgh.geom2d.ContinuousCurve2D#appendPath(Path)
     */
