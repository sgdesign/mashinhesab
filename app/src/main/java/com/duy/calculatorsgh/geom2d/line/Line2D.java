...
package com.duy.calculatorsgh.geom2d.line;

import android.graphics.Path;

import com.duy.calculatorsgh.geom2d.GeometricObject2D;
import com.duy.calculatorsgh.geom2d.Point2D;
import com.duy.calculatorsgh.geom2d.Vector2D;
import com.duy.calculatorsgh.geom2d.curve.AbstractSmoothCurve2D;
import com.duy.calculatorsgh.geom2d.util.Shape2D;

import java.util.Collection;

public class Line2D extends AbstractSmoothCurve2D
        implements com.duy.calculatorsgh.geom2d.line.LinearShape2D, Cloneable {
    ...
    public Line2D(com.duy.calculatorsgh.geom2d.line.StraightLine2D mLine) {
        this(mLine.x0, mLine.y0, mLine.dx, mLine.dx);
    }

    /**
     * Checks if two line intersect. Uses the
     * {@link com.duy.calculatorsgh.geom2d.Point2D#ccw(Point2D, Point2D, Point2D) Point2D.ccw}
    ...
    public boolean isColinear(com.duy.calculatorsgh.geom2d.line.LinearShape2D line) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).isColinear(line);
    }
     ...
     */
    public boolean isParallel(com.duy.calculatorsgh.geom2d.line.LinearShape2D line) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).isParallel(line);
    }

    @Override
    public boolean containsProjection(Point2D point) {
        double pos = new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).project(point);
    ...
    public double[][] parametric() {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).parametric();
    }
    ...
    public double[] cartesianEquation() {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).cartesianEquation();
    }

    public double[] polarCoefficients() {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).polarCoefficients();
    }

    public double[] polarCoefficientsSigned() {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).polarCoefficientsSigned();
    }

    public double horizontalAngle() {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).horizontalAngle();
    }

    /* (non-Javadoc)
     * @see LinearShape2D#intersection(LinearShape2D)
     */
    public Point2D intersection(com.duy.calculatorsgh.geom2d.line.LinearShape2D line) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).intersection(line);
    }
     ...
     */
    public com.duy.calculatorsgh.geom2d.line.StraightLine2D supportingLine() {
        return new com.duy.calculatorsgh.geom2d.line.StraightLine2D(p1, p2);
    }
    ...
    public double signedDistance(double x, double y) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).signedDistance(x, y);
    }

    /**
     * Returns false.
     *
     * @see com.duy.calculatorsgh.geom2d.curve.ContinuousCurve2D#isClosed()
     */
    ...
    public double distance(double x, double y) {
        ...
        com.duy.calculatorsgh.geom2d.line.StraightLine2D support = new com.duy.calculatorsgh.geom2d.line.StraightLine2D(p1, p2);
     ...
     */
    public com.duy.calculatorsgh.geom2d.line.StraightLine2D parallel( Point2D point) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).parallel(point);
    }
     ...
     */
    public com.duy.calculatorsgh.geom2d.line.StraightLine2D perpendicular( Point2D point) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).perpendicular(point);
    }
    ...
    @Override
    public com.duy.calculatorsgh.geom2d.polygon.LinearCurve2D asPolyline( int n) {
        return null;
    }

    public double windingAngle(Point2D point) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).windingAngle(point);
    }

    public boolean isInside(Point2D point) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).signedDistance(point) < 0;
    }
    ...
    public double position(Point2D point) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).position(point);
    }

    public double project(Point2D point) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).project(point);
    }
     ...
     */
    public Collection<Point2D> intersections(com.duy.calculatorsgh.geom2d.line.LinearShape2D line) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).intersections(line);
    }
    ...
    public boolean contains(double x, double y) {
        return new com.duy.calculatorsgh.geom2d.line.LineSegment2D(p1, p2).contains(x, y);
    }
