 ...
 * @author dlegland
 */
public class MultiPolygon2D implements com.duy.calculatorsgh.geom2d.polygon.Polygon2D {
    ...
    public com.duy.calculatorsgh.geom2d.polygon.Polygon2D complement() {
    ...
    public boolean contains(double x, double y) {
        return this.contains(new com.duy.calculatorsgh.geom2d.Point2D(x, y));
    }
