...
import com.duy.calculatorsgh.geom2d.util.EqualUtils;
...
import com.duy.calculatorsgh.geom2d.util.UnboundedShape2DException;
import com.duy.calculatorsgh.geom2d.Vector2D;
import com.duy.calculatorsgh.geom2d.curve.Curve2D;
...
public class StraightLine2D extends AbstractLine2D implements
     ...
     */
    public StraightLine2D(com.duy.calculatorsgh.geom2d.line.LinearShape2D line) {
     ...
     */
    public StraightLine2D( com.duy.calculatorsgh.geom2d.line.LinearShape2D line, Point2D point) {
    ...
    public static Point2D getMidPoint(com.duy.calculatorsgh.geom2d.line.Line2D line2D) {
     ...
     * @since 0.6.3
     */
    public static StraightLine2D createParallel(com.duy.calculatorsgh.geom2d.line.LinearShape2D line,
                                                Point2D point) {
     ...
     * @since 0.6.3
     */
    public static StraightLine2D createParallel(com.duy.calculatorsgh.geom2d.line.LinearShape2D linear,
                                                double d) {
    ...
    public static StraightLine2D createPerpendicular(
            com.duy.calculatorsgh.geom2d.line.LinearShape2D linear, Point2D point) {
        StraightLine2D line = linear.supportingLine();
